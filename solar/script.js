...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const DATA = {
    ...
    en: {
      hasAudio: true,
      src: 'assets/english-demo-solar-v2.mp3',
      ...
      lines: [
        ...
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'Yes, speaking. Who\'s this?', t: 3.7 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'Hi, I\'m Priya... calling from Sri Surya Solar.', t: 6.9 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'You\'d enquired about rooftop solar... on Facebook, right?', t: 12.2 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'Yes, I did. Tell me.', t: 17.1 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'Great... so just two quick things. Yours is an independent house, correct?', t: 19.4 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'Yes, independent house.', t: 25.5 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'Nice. And... is there open space on the terrace?', t: 27.9 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'Yes, the terrace is mostly empty.', t: 33.1 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'Got it... so what\'s the monthly electricity bill like?', t: 35.8 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'Hmm... around three thousand.', t: 40.7 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'Understood... so, independent house, empty terrace, three-thousand bill — correct?', t: 43.9 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'Yes, that\'s right.', t: 52 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'Then your enquiry qualifies. Our team... will contact you for the site survey. Thank you!', t: 53.9 },
      ],
    },
    hi: {
      hasAudio: true,
      src: 'assets/hindi-demo-solar-v2.mp3',
      ...
      lines: [
        ...
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'नमस्ते, मैं प्रिया बोल रही हूँ... श्री सूर्या सोलर से कॉल कर रही हूँ।', t: 6.1 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'आपने रूफटॉप सोलर के बारे में... फेसबुक पर इन्क्वायरी की थी, है ना?', t: 12.1 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'हाँ, की थी। बताइए।', t: 17.5 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'ठीक है... तो दो छोटी बातें पूछूँगी। आपका इंडिपेंडेंट हाउस है ना?', t: 20.8 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'हाँ, इंडिपेंडेंट हाउस ही है।', t: 26.7 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'बढ़िया। और... छत पर खाली जगह है?', t: 29.8 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'हाँ, छत खाली ही है।', t: 33.9 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'अच्छा... तो महीने का बिजली बिल कितना आता है?', t: 37 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'हम्म... तीन हज़ार तक आ जाता है।', t: 41.8 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'समझ गई... मतलब, इंडिपेंडेंट हाउस, छत खाली, बिल तीन हज़ार — सही है ना?', t: 45.5 },
        { who: 'prospect',  name: 'Deva (Prospect)', text: 'हाँ, बिल्कुल सही।', t: 52.8 },
        { who: 'ai',        name: 'AI Voice Agent (Priya)', text: 'तो आपकी इन्क्वायरी क्वालिफाई हो गई है। हमारी टीम... साइट सर्वे के लिए संपर्क करेगी। धन्यवाद!', t: 55.4 },
      ],
    },
  };
