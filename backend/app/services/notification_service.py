...
async def notify_owner_email(
    ...
    if transcript:
        ...
        <div style="margin-top: 16px; padding: 12px; background: #F3F4F6; border-radius: 8px;">
            ...
            <p style="margin: 8px 0 0; color: #374151;">{transcript}</p>
        </div>
        """
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto;">
        <div style="background: #1E293B; color: white; padding: 20px; border-radius: 12px 12px 0 0;">
            <h2 style="margin: 0; font-size: 18px;">🔔 New Lead for {business_name}</h2>
        </div>
        <div style="padding: 20px; border: 1px solid #E5E7EB; border-top: none; border-radius: 0 0 12px 12px;">
            ...
            <table style="width: 100%; margin-top: 16px; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 8px 0; font-weight: 600;">{name_str}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 8px 0; font-weight: 600;">{service_str}</td>
                </tr>
            </table>
            ...
            <div style="margin-top: 20px; text-align: center;">
                <a href="tel:{lead_phone}" style="display: inline-block; padding: 12px 24px; background: #2563EB; color: white; border-radius: 8px; text-decoration: none; font-weight: 600;">
                    📞 Call {name_str} Back
                </a>
            </div>
        </div>
        ...
        resend.Emails.send(
            {
                ...
                "to": [owner_email],
                "subject": f"🔔 New {urgency.upper()} lead: {name_str} — {service_str}",
                "html": html,
            }
        )
