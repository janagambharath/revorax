...
export const VERTICAL_PACKS: Record<BusinessType, VerticalPack> = {
  GYM: {
    ...
    positioning: 'Keep every member. Get 15% more renewals.',
  ...
  CLINIC: {
    ...
    positioning: 'Fill 100% of appointment slots with automated recalls.',
  ...
  SALON: {
    ...
    positioning: 'Turn every client into a repeat client.',
  ...
  COACHING: {
    ...
    positioning: 'Convert every inquiry. Collect every fee.',
  ...
  REAL_ESTATE: {
    ...
    positioning: 'Book more site visits. Close more deals.',
  ...
  DENTAL: {
    ...
    positioning: 'Never miss a recall. Fill every chair.',
  ...
  AGENCY: {
    ...
    positioning: 'Win more proposals. Retain every client.',
  ...
  OTHER: {
    ...
    positioning: 'Recover lost revenue with smarter follow-up.',
